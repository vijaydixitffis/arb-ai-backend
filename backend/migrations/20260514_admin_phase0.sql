-- ============================================================================
-- Phase 0: Admin Tables Migration (PostgreSQL / Python backend)
-- 2026-05-14
-- ============================================================================
...
-- ── 7. Seed: super_admin user (password: password123 — CHANGE IN PRODUCTION) ─
...
-- Ensure existing arb_admin is active
UPDATE users SET is_active = true WHERE role = 'arb_admin';
